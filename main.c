...
void louer_voiture()
{
    ...
    while (c.datelouer.a>c.datelouer.a ||c.datelouer.a>c.datelouer.a && c.datelouer.m>c.dateretour.m ||c.datelouer.a==c.dateretour.a&&c.datelouer.m==c.dateretour.m&&c.datelouer.j>c.dateretour.j);
    FILE *ptr;
