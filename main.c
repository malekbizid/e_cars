...
void louer_voiture()
{
    ...
    printf("ENTREZ LE MODELE QUE VOUS SOUHAITEZ LOUER:  ");
    ...
    while (c.datelouer.a>c.dateretour.a ||c.datelouer.a==c.dateretour.a && c.datelouer.m>c.dateretour.m ||c.datelouer.a==c.dateretour.a&&c.datelouer.m==c.dateretour.m&&c.datelouer.j>c.dateretour.j);
    FILE *ptr;
...
int main()
{
    ...
    scanf("%d", &p);
    while (p == 1) {
        printf("\aSALUT !! ETES-VOUS ICI POUR PRENDRE LE SERVICE DE VOITURE OU POUR RENDRE LA VOITURE OU FAIRE UNE RECALAMTION? \n 1. LOUER UNE VOITURE.\n 2. RETOURNER LA VOITURE.\n 3.FAIRE UNE RECLAMATION\n");
        scanf("%d", &q);
        switch (q) {
            case 1:
                louer_voiture();
